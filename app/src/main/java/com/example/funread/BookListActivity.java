        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            viewHoder.mButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //在这里实现下载和打开的功能
                    String bookDownload = book.getBookfile();
                    OkHttpClient okHttpClient = new OkHttpClient();
                    Request request = new Request.Builder().url(bookDownload).get().build();
                    Call call = okHttpClient.newCall(request);
                    call.enqueue(new Callback() {
                        @Override
                        public void onFailure(@NonNull Call call, @NonNull IOException e) {
                            finalViewHoder.mButton.setText("下载失败");
                        }

                        @Override
                        public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                            finalViewHoder.mButton.setText("点击打开");
                        }
                    });
